...
### Python Verification
A golden reference model is designed in python to validate the hardware implementation. [compare.py](Python_verification/compare.py) file can be used to compare the output.dat files generated by python golden reference model and output file from bluespec simulation [Detailed description](Report.pdf). 
